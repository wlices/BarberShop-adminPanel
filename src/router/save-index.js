...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      name: 'authredirect',
      path: 'authredirect',
      component: lazyLoading('auth/login/authredirect'),
    },
    {
      path: '/auth',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'services',
          path: 'services',
          component: lazyLoading('services/Services'),
          default: true,
        },
        {
          name: 'create-service',
          path: 'services/create',
          component: lazyLoading('services/createService'),
          default: true,
        },
        {
          name: 'update-service',
          path: 'services/update/:id',
          component: lazyLoading('services/updateService'),
          default: true,
        },
        {
          name: 'statistics',
